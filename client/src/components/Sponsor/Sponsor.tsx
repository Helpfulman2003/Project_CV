...
const Sponsor = () => {
    const sponsors = [
        ...
        "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/LG_logo_%282014%29.svg/600px-LG_logo_%282014%29.svg.png",
        ...
        // Add more sponsor image URLs here
      ];
  return (
        ...
        <div className='hidden md:grid grid-cols-5 gap-16 bg-white shadow-md rounded-md px-4 py-10 cursor-pointer'>
            {
                sponsors.map((sponsor: string, index: number) => {
                    return (
                        <div key={index}>
                            <img src={sponsor} alt="" className='w-full object-cover'/>
                        </div>
                    )
                })
            }
