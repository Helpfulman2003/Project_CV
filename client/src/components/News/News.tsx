        ...
        <div className='md:block hidden w-full px-[10%] mt-0 md:mt-[50px]'>
            <div className='flex items-center justify-between bg-white shadow-md py-5 px-5 rounded'>
                ...
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <div>
                        <h3 className='text-[16px] font-bold'>Daily Surprise Offers</h3>
                ...
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <div>
                        <h3 className='text-[16px] font-bold'>Affortable Prices</h3>
                ...
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <div>
                        <h3 className='text-[16px] font-bold'>Secure Payments</h3>
                        <p className=''>100% protected payments</p>
                    </div>
                </div>
            </div>
